...
namespace Netgen\Bundle\InformationCollectionPlatformUIBundle\Form\Type\FieldDefinition;
...
class FieldDefinitionType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('isInfoCollector', CheckboxType::class, ['required' => false, 'label' => 'field_definition.is_infocollector'])
